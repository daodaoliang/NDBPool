...
int main(int argc, char *argv[])
{
    ...
    qDebug() << "/**************************开始测试用例**************************/";
    {
        ...
        QSqlDatabase tempDB = NDBPool::getNewConnection("127.0.0.1","test","root","Fuck1024",3306);
        qDebug() << " connection name:" << tempDB.connectionName() << "is vaild:" << tempDB.isOpen() << "\n";
        QSqlDatabase tempDB1 = NDBPool::getNewConnection("127.0.0.1","test","root","Fuck1024",3306);
        qDebug() << " connection name:" << tempDB1.connectionName() << "is vaild:" << tempDB1.isOpen() <<"\n";
        QSqlDatabase tempDB2 = NDBPool::getNewConnection("127.0.0.1","test","root","Fuck1024",3306);
        qDebug() << " connection name:" << tempDB2.connectionName() << "is vaild:" << tempDB2.isOpen() <<"\n";
        QSqlDatabase tempDB3 = NDBPool::getNewConnection("127.0.0.1","test","root","Fuck1024",3306);
        qDebug() << " connection name:" << tempDB3.connectionName() << "is vaild:" << tempDB3.isOpen() <<"\n";
        QSqlDatabase tempDB4 = NDBPool::getNewConnection("127.0.0.1","test","root","Fuck1024",3306);
